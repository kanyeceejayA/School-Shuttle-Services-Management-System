				...
				<ul class="nav navbar-nav">
					...
					<li class='dropdown active'>
						...
						<ul class='dropdown-menu'>
							...
							<li class='active'><a href='viewstaff.php'>View Staff</a></li>
						</ul>
					</li> ";} ?>
		...
		<h3 align="center" >
			...
			<h4>Drivers</h4>
		    	...
		    	<table style="width: 80%; max-width: 768px" class="table table-bordered">
		    		<tr><th>Picture</th><th>Name</th><th>Phone</th><th>Shuttle</th><th>permit</th></tr>
		    		<?php
			                $sql2 = "SELECT staffName, staffNumber, staffPicture, shuttleno, permitno FROM drivershuttle;";
			                ...
			                if ($driver->num_rows > 0) {
			                    ...
			                    while($row = $driver->fetch_assoc()) {
			                        echo 
			                        "<tr><td> <img src= '" . $row["staffPicture"] . "' height='100px' width='100px' class='img-rounded'>
			                        </td><td>
			                        ".$row["staffName"]."
			                        </td><td>
			                        ". $row["staffNumber"]."
		    	...
		    	<h4 align="center">Teachers</h4>
		    	<table style="width: 80%; max-width: 768px" class="table table-bordered">
		    		<tr><th>Picture</th><th>Name</th><th>Phone Number</th><th>Shuttle</th></tr>
		    		<?php
			            function getTeacherDetails($db){
			                $sql = "SELECT staffName, staffNumber, staffPicture, shuttleno FROM teachershuttle;";
			                $driver = $db->query($sql);
